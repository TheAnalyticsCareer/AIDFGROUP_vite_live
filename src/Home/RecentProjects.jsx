...
import project_6 from "./HomeImg/p6.jpeg";

const RecentProjects = () => {
  const projects = [
    { id: 1, title: "Wood & Composites", image: project_1 },
        { id: 2, title: "Dalaan Carpet Tiles", image: project_6 },
    { id: 3, title: "Hospitality & Banquet Carpet", image: project_2 },
    { id: 4, title: "Wall Covering", image: project_3 },
    { id: 5, title: "Laminate Wooden Flooring", image: project_4 },
    { id: 6, title: "Modular Carpet Tiles", image: project_5 },
  ];
          ...
          >
            {projects.map((project) => (
              <SwiperSlide key={project.id}>
                ...
                >
                  <div className="recent-project-image-container" style={{ position: "relative" }}>
                    <img
                      src={project.image}
                      alt={project.title}
                      className="recent-project-image"
                    />
                    {/* Newly Launched Badge for Dalaan Carpet Tiles */}
                    {project.title === "Dalaan Carpet Tiles" && (
                      <div
                        style={{
                          position: "absolute",
                          top: 10,
